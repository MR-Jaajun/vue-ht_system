 ...
 * @LastEditors: jun
 * @LastEditTime: 2019-10-18 10:44:30
 -->
<template>
    ...
    getdata() {
      this.$axios({
        ...
        if (res.status == 200) {
          ...
          this.superior.push(res.data.data.uperior_info_data);
          //账户信息
          this.user_status = res.data.data.status;
          ...
          this.commission_amount = res.data.data.commission_amount;
          this.balance_amount = res.data.data.user_info_data.balance_amount;
          this.mobile = res.data.data.mobile;
          //基本信息
          this.user_info_data = res.data.data.user_info_data;
          this.textarea2 = res.data.data.user_info_data.remark;
          //上级信息
          this.uperior_info_data = res.data.data.uperior_info_data;
    ...
    memberChildren(page) {
      ...
      this.$axios({
        ...
        if (res.data.status == 1) {
          this.loading = false;
          console.log(res.data.data.data, "下家");
