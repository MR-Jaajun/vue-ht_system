<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>推荐专区（商城）</el-breadcrumb-item>
    </el-breadcrumb>
    <h1>推荐专区（商城）审核列表</h1>
    <!-- 广告信息 -->
    <div class="edit">
    ...
    <section class="vip-table" style=" width: fit-content;">
      ...
      >
        ...
        <el-table-column prop="shop_title" label="店铺名称" align="center" width="180"></el-table-column>

        <el-table-column prop="pay_fee" label="订单金额" align="center" width="120"></el-table-column>
        <el-table-column prop="day_count" label="购买天数" align="center" width="120"></el-table-column>
        ...
        <el-table-column prop="sort" label="广告排序" align="center" width="100"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //广告申请列表 /backend/Advert/advertList
    advertList(page) {
      this.loading = true;
      this.$axios({
        method: "GET",
        url: "/backend/Advert/advertListone",
        params: {
          module: "2",
        ...
        if (res.data.status == 1) {
          ...
          //   let arrs = [];
          //   item.advert_time.forEach(item2 => {
          //     arrs.push(item2.advert_day);
          //   });
          //   item.arr = arrs;
          // });
        } else {
