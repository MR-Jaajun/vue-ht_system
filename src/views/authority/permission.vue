 ...
 * @LastEditors: Roc
 * @LastEditTime: 2019-10-30 14:05:01
 -->
<template>
  <div class="roledetails-wepper">
    <el-breadcrumb separator="/">
      <el-breadcrumb-item>权限管理</el-breadcrumb-item>
      <el-breadcrumb-item>代理商后台权限管理</el-breadcrumb-item>
    </el-breadcrumb>
    <h1>代理商后台权限管理</h1>
    <div class="divform">
      <!-- <h2>
...
export default {
  ...
  methods: {
    ...
    getdataed() {
      this.$axios({
        method: "GET",
        url: "/backend/AuthManagement/agentPermissionList"
      }).then(res => {
    ...
    DefaultRoleInfo() {
      this.$axios({
        method: "GET",
        url: "/backend/AuthManagement/agentDefaultRoleInfo"
      }).then(response => {
    ...
    tjclick() {
      ...
      this.$axios({
        method: "POST",
        url: "/backend/AuthManagement/agentDefaultRole",
        data: {
