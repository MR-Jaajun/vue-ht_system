 ...
 * @Description: 
 * @Author: jun
 * @Date: 2019-09-05 09:03:32
 * @LastEditors: Roc
 * @LastEditTime: 2019-12-02 10:30:25
 -->
<template>
  <div class="afterdetails_wapper">
    <el-breadcrumb separator="/">
      <el-breadcrumb-item>订单管理</el-breadcrumb-item>
      <el-breadcrumb-item to="afterSale">外卖售后订单管理</el-breadcrumb-item>
    ...
    <div class="shopinfo common">
      ...
      <div class="common2">
        ...
        <li>
          <span>店铺地址</span>
          <span>{{shoplist.province}}{{shoplist.city}}{{shoplist.area}}</span>
        </li>
        <li>
          <span>店铺信息</span>
...
export default {
  ...
  created() {
    this.order_ids = this.$route.params.order_id;
    this.getAllinfo();
  },
  methods: {
    //返回上一页
    ...
    getAllinfo() {
      this.$axios({
        method: "GET",
        url: "/backend/Order/takeoutRefundDetail",
        params: {
        ...
        console.log(this.shoplist, "商品信息");
        ...
        if (res.data.data.refund_record[0]) {
