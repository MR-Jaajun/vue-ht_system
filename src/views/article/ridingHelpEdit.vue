<!--
 * @Description: 新增编辑骑手填写资料帮助列表
 * @LastEditors: duo
 * @LastEditTime: 2019-09-25 15:02:30
 -->
 <template>
  <div class="setwidth" id="addplatform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './ridingHelpList' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: './ridingHelpList' }">骑手填写资料帮助列表</el-breadcrumb-item>
      <el-breadcrumb-item>{{this.params.titletxt}}骑手填写资料帮助</el-breadcrumb-item>
    </el-breadcrumb>
