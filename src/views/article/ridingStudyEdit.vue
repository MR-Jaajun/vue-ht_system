<!--
 * @Description: 新增编辑骑手在线学习
 * @LastEditors: duo
 * @LastEditTime: 2019-09-25 15:07:03
 -->
 <template>
  <div class="setwidth" id="addplatform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './ridingStudyList' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: './ridingStudyList' }">骑手在线学习列表</el-breadcrumb-item>
      <el-breadcrumb-item>{{this.params.titletxt}}骑手在线学习</el-breadcrumb-item>
    </el-breadcrumb>
