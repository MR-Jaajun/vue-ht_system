 ...
 * @Description: 商户文章管理
 * @LastEditors: duo
 * @LastEditTime: 2019-09-25 14:26:21
 -->
<template>
  <div class="pagelist platform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './shopArticlesList' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item>商户文章列表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-row>
  ...
  methods: {
    ...
    getList() {
      return new Promise((resolve, reject) => {
        ...
        this.$axios({
          method: 'GET',
          url: '/backend/Article/shopArticleList',
    ...
    toInfo(row) {
      ...
      this.$router.push({ name: 'shopArticlesEdit', params: { row, titletxt } })
    },
