  ...
  methods: {
    ...
    getList() {
      return new Promise((resolve, reject) => {
        ...
        this.$axios({
          method: 'GET',
          url: '/backend/Article/serverArticleList',
    ...
    toInfo(row) {
      ...
      this.$router.push({ name: 'customeredit', params: { row, titletxt } })
    },
