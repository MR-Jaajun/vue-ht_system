  ...
  methods: {
    ...
    getList() {
      return new Promise((resolve, reject) => {
        ...
        this.$axios({
          method: 'GET',
          url: '/backend/Article/riderStudyArticleList',
    ...
    toInfo(row) {
      ...
      this.$router.push({ name: 'ridingStudyEdit', params: { row, titletxt } })
    },
