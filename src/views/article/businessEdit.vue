<!--
 * @Description: 新增&编辑商户管理规范
 * @LastEditors: duo
 * @LastEditTime: 2019-09-25 14:19:31
 -->
 <template>
  <div class="setwidth" id="addplatform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './businessList' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: './businessList' }">商户管理规范列表</el-breadcrumb-item>
      <el-breadcrumb-item>{{this.params.titletxt}}商户管理规范</el-breadcrumb-item>
    </el-breadcrumb>
