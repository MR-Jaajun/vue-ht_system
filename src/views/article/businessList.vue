 ...
 * @Description: 商户管理规范
 * @LastEditors: duo
 * @LastEditTime: 2019-11-20 14:36:22
 -->
<template>
  <div class="pagelist platform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './businessList' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item>商户管理规范列表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-row>
    ...
    <div id="actList">
      ...
      >
        ...
        <el-table-column prop="title" label="文章名称" width="400" align="center"></el-table-column>
        <!-- <el-table-column prop="position_value" label="文章位置" width="200" align="center"></el-table-column> -->
        <el-table-column sortable prop="update_time" label="更新时间" width="400" align="center"></el-table-column>
  ...
  methods: {
    ...
    getList() {
      return new Promise((resolve, reject) => {
        ...
        this.$axios({
          method: 'GET',
          url: '/backend/Article/shopRuleArticleList',
    ...
    toInfo(row) {
      ...
      this.$router.push({ name: 'businessEdit', params: { row, titletxt } })
    },
