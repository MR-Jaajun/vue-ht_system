<!--
 * @Description: 新增客服中心文章
 * @LastEditors: duo
 * @LastEditTime: 2019-10-12 11:49:36
 -->
 <template>
  <div class="setwidth" id="addplatform">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: './customer' }">文章管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: './customer' }">客服中心文章列表</el-breadcrumb-item>
      <el-breadcrumb-item>{{this.params.titletxt}}客服中心文章</el-breadcrumb-item>
    </el-breadcrumb>
