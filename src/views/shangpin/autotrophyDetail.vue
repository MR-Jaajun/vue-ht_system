<template>
  <div class="autotrophyDetail">
    <el-breadcrumb separator-class="/">
      ...
      <el-breadcrumb-item>平台商品池</el-breadcrumb-item>
    ...
    <el-dialog title="提示" :visible.sync="dialogFormVisible" custom-class="dialog">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-show="type==0" type="primary" @click="setConfirm(0) ">确 定</el-button>
        <el-button v-show="type==1" type="primary" @click="setConfirm(1) ">确 定</el-button>
      </div>
    </el-dialog>
    <div class="goods">
      <!-- 基本信息 -->
      <div class="info" style="border-bottom:0">
        ...
        <div class="infos">
          <div class="basic_info">
            <span>商品状态：</span>
            <span
              :style="{color:base_info.goods_status==0?'#F85353':'#333333'}"
            >{{base_info.goods_status==0?'未上架':'已上架'}}</span>
          </div>
          <div class="basic_info">
            <span>商品名称：</span>
          ...
          <div class="info3_div" v-for="(item, index) in sale_info.goods_sku_data" :key="index">
            ...
            <div class="info3_div_right">
              ...
              <div class="ginfo">
                <div class="price">
                  <span>库存量：</span>
                  <span style="color:#333333">{{item.sku_stock}}</span>
                </div>
                <div class="price">
                  <span>基础销量：</span>
                ...
                <div class="price">
                  <span>实际销量：</span>
                  <span style="color:#333333">{{item.sku_seckill_stock}}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- 按钮 -->
    <div class="btn">
      <el-button type="primary" plain v-show="base_info.goods_status==0" @click="addBack()">立即上架</el-button>
...
export default {
  ...
  methods: {
    ...
    // 获取平台商品详情
    details() {
      this.$get("/backend/JdGoods/ptGoodsInfo", {
        goods_id: this.goods_id
      }).then(res => {
